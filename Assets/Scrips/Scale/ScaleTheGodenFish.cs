...
public class ScaleTheGodenFish : MonoBehaviour
{
    private string TIP_NOSCALETIMES = "Waitwaitwait,you've ran out of the scaling chances.";

    private string TIP_MINWEIGHTOFFFISH = "The minimum weight of a goden pufferfish is 30, we don¡¯t pursue a slim figure.";
